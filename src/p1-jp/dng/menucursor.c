/* Persona 1 (JP) - menu cursor movement.  DNG @ 0x80077538.
 *
 * S2D has the same routine at 0x80067560 against its own pad word, so it keeps
 * src/p1-jp/s2d/menucursor.c. ADV's copy at 0x80067D70 is a different function:
 * it has the click sound inlined rather than calling SoundPlaySeq, which makes
 * it 28 instructions longer.
 *
