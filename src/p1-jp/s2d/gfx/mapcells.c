/* Persona 1 (JP) - the cell definitions behind the character maps, S2D copy.
 *
 * Compiled into three overlays rather than called across the boundary:
 *                  S2D
 *   FontCellsInit  0x8007B7D4
 *
 ...
 *
 * The cell array sits 0x20000 above the DNG and ADV copies; see
 * src/p1-jp/common/gfx/mapcells.c for the shared original.
 */
#include <types.h>
#include <libgs.h>

/* Reached by hardcoded address; the blank is the cell before the atlas. */
#define g_font_blank ((GsCELL *)0x8010864C)
#define g_font_cells ((GsCELL *)0x80108654)
