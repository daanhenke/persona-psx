/* Persona 1 (JP) - the filtered item list the item menus page through, S2D copy.
 *
 ...
 *
 *   S2D 0x80083020; the list sits 0x20000 above the DNG and ADV copies.
 */
#include <types.h>

#define g_item_list ((u_short *)0x8010AE4C)
