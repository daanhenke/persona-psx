 ...
 *
 *   S2D 0x8007476C.  Its character map sits 0x20000 above the other two;
 *   see src/p1-jp/common/ui/placelabel.c for the original.
 *
...
#define LABEL_ROW0  ((short *)0x8010F71C)
#define LABEL_ROW1  ((short *)0x8010F736)
