/* Persona 1 (JP) - one party member's block in the field status HUD, S2D copy.
 *
 *   S2D @ 0x8007AAF0
 *
 ...
 *
 * The layer sits 0x20000 above the ADV copy; see
 * src/p1-jp/common/ui/partyhud.c for the shared original.
 */
#include <types.h>
