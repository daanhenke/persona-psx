 ...
 *   DNG 0x80093188   ADV 0x8008F0E8   S2D 0x8008369C
 *
 ...
 * the same job for backgrounds; this one produces GsCELLs. Blanking a run is
 * a unit of its own ahead of this one, in cells.c.
 */
