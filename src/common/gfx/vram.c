...
/* Clears the rectangle to black.

   Not wired in any overlay yet: gcc schedules the `sw ra` one slot later than
   the original, which puts the whole prologue out by a word. */
