...
extern u_char g_btl_edit_mag_atk_cells[];
extern u_char g_btl_edit_mag_def_cells[];
...
void BtlFillEditBoard(BtlActor *a)
{
    ...
    BtlDrawNumber(g_btl_edit_mag_atk_cells, a->c.mag_atk, 3);
    BtlDrawNumber(g_btl_edit_mag_def_cells, a->c.mag_def, 3);
